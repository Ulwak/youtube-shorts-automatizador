...
def main():
    ...
    try:
        ...
        print("Error de conexion o de API, no se pudo rellenar el stock de memes desde internet.")
        ...
        if any(cantidad < (cantidad_shorts * 2) for cantidad in stock.values()):
            ...
            continuar = input("¿Desea continuar la ejecucion? (Y para continuar o ingrese cualquier letra / numero para detener la ejecucion y rellenar manualmente las carpetas con memes o ejecutar el programa nuevamente para rellenar las carpetas mediante la API)")
            if continuar != "Y":
                exit()
