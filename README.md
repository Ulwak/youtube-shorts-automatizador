...
2. ¿Qué significa cada carpeta y qué hace cada modulo de codigo?
...
4. El automatizador de shorts funciona extrayendo memes desde una API publica llamada Meme-API creada por D3vd. De esta manera el programa obtiene los memes y posteriormente los somete a un filtro simple para evitar repetidos. El filtro consiste en tres etapas:
